...
Recordset1_cmd.CommandText = "SELECT * FROM video.用户 WHERE 工号 = '13030140000'" 
...
Recordset2_cmd.CommandText = "SELECT * FROM video.信息, video.视频 WHERE 用户工号 = '13030140000' AND 类 = '统计学' and 视频ID = ID" 
...
Recordset3_cmd.CommandText = "SELECT * FROM video.信息, video.视频 WHERE 用户工号 = '13030140000' AND 类 = '数学' and 视频ID = ID" 
...
Recordset4_cmd.CommandText = "SELECT * FROM video.信息, video.视频 WHERE 用户工号 = '13030140000' AND 类 = 'MBA' and 视频ID = ID" 
...
Recordset5_cmd.CommandText = "SELECT * FROM video.信息, video.视频 WHERE 用户工号 = '13030140000' AND 类 = '计算机' and 视频ID = ID" 
...
Recordset6_cmd.CommandText = "SELECT * FROM video.信息, video.视频 WHERE 用户工号 = '13030140000' AND 类 = '统计软件' and 视频ID = ID" 
...
<font style=" background-color: yellow" size="+2">视频<%=Repeat1__index+1%>：</font></td>
      <td><a href="video.asp?ID=<%=(Recordset2.Fields.Item("md5").Value)%>"><font style=" background-color: yellow" size="+2"><%=(Recordset2.Fields.Item("视频名").Value)%></font></a></td>
       <td width="150" style="padding-left:25px"><div class="graph"><span class="green" style="width:<%if INT(Recordset2.Fields.Item("总长度").Value) <> 0 then
	     a = FormatNumber(INT(Recordset2.Fields.Item("总长度").Value) / INT(Recordset2.Fields.Item("时长").Value) * 100,2)
	   if a > 100 then
	   ...
	   response.Write("0.00")
	   end if%>%;color:#000; text-align:right"><%if INT(Recordset2.Fields.Item("总长度").Value) <> 0 then
	     a = FormatNumber(INT(Recordset2.Fields.Item("总长度").Value) / INT(Recordset2.Fields.Item("时长").Value) * 100,2)
	   if a > 100 then
	   response.Write("100.00")
	   elseif a < 1 then
...
%>
    ...
    <tr >
      ...
      <td><a href="video.asp?ID=<%=(Recordset3.Fields.Item("md5").Value)%>"><font style=" background-color: yellow" size="+2"><%=(Recordset3.Fields.Item("视频名").Value)%></font></a></td>
       <td width="150" style="padding-left:25px"><div class="graph"><span class="blue" style="width:<%if INT(Recordset3.Fields.Item("总长度").Value) <> 0 then
	     a = FormatNumber(INT(Recordset3.Fields.Item("总长度").Value) / INT(Recordset3.Fields.Item("时长").Value) * 100,2)
	   if a > 100 then
	   response.Write("100.00")
	   elseif a < 1 then
	   response.Write("0"&a)
	   ...
	   response.Write("0.00")
	   end if%>%;color:#ff6e6e; text-align:right"><%if INT(Recordset3.Fields.Item("总长度").Value) <> 0 then
	    a = FormatNumber(INT(Recordset3.Fields.Item("总长度").Value) / INT(Recordset3.Fields.Item("时长").Value) * 100,2)
	   if a > 100 then
	   response.Write("100.00")
	   elseif a < 1 then
...
%>
    ...
    <tr >
      ...
      <td><a href="video.asp?ID=<%=(Recordset5.Fields.Item("md5").Value)%>"><font style=" background-color: yellow" size="+2"><%=(Recordset5.Fields.Item("视频名").Value)%></font></a></td>
       <td width="150" style="padding-left:25px"><div class="graph"><span class="red" style="width:<%
	   if INT(Recordset5.Fields.Item("总长度").Value) <> 0 then
	    a = FormatNumber(INT(Recordset5.Fields.Item("总长度").Value) / INT(Recordset5.Fields.Item("时长").Value) * 100,2)
	   if a > 100 then
	   response.Write("100.00")
	   elseif a < 1 then
	   response.Write("0"&a)
	   ...
	   %>%;color:#ff6e6e; text-align:right"><%if INT(Recordset5.Fields.Item("总长度").Value) <> 0 then
	   a = FormatNumber(INT(Recordset5.Fields.Item("总长度").Value) / INT(Recordset5.Fields.Item("时长").Value) * 100,2)
	   if a > 100 then
	   response.Write("100.00")
	   elseif a < 1 then
...
%>
    ...
    <tr >
      ...
      <td width="150" style="padding-left:25px"><div class="graph"><span class="orange" style="width:<%if INT(Recordset4.Fields.Item("总长度").Value) <> 0 then
	   response.Write(FormatNumber(INT(Recordset4.Fields.Item("总长度").Value) / INT(Recordset4.Fields.Item("时长").Value) * 100,2))
	   else
	   response.Write("0.00")
	   end if%>%;color:#000; text-align:right"><%if INT(Recordset4.Fields.Item("总长度").Value) <> 0 then
	    a = FormatNumber(INT(Recordset4.Fields.Item("总长度").Value) / INT(Recordset4.Fields.Item("时长").Value) * 100,2)
	   if a > 100 then
	   response.Write("100.00")
	   elseif a < 1 then
	   response.Write("0"&a)
...
<font style=" background-color: yellow" size="+2">视频<%=Repeat5__index+1%>：</font></td>
      <td><a href="video.asp?ID=<%=(Recordset6.Fields.Item("md5").Value)%>"><font style=" background-color: yellow" size="+2"><%=(Recordset6.Fields.Item("视频名").Value)%></font></a></td>
       <td width="150" style="padding-left:25px"><div class="graph"><span class="green" style="width:<%if INT(Recordset6.Fields.Item("总长度").Value) <> 0 then
	     a = FormatNumber(INT(Recordset6.Fields.Item("总长度").Value) / INT(Recordset6.Fields.Item("时长").Value) * 100,2)
	   if a > 100 then
	   response.Write("100.00")
	   elseif a < 1 then
	   response.Write("0"&a)
	   ...
	   response.Write("0.00")
	   end if%>%;color:#000; text-align:right"><%if INT(Recordset6.Fields.Item("总长度").Value) <> 0 then
	     a = FormatNumber(INT(Recordset6.Fields.Item("总长度").Value) / INT(Recordset6.Fields.Item("时长").Value) * 100,2)
	   if a > 100 then
	   response.Write("100.00")
	   elseif a < 1 then
